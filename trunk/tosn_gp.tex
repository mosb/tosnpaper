...
\noindent The most stable implementation of equation \eqref{eq:GPMeanVar2} involves the use of the Cholesky decomposition, $\mat{R}(\vzD,\vzD)$, of $\mat{V}(\vzD,\vzD)$, such that $\mat{V}(\vzD,\vzD)=\mat{R}(\vzD,\vzD)^\tr\,\mat{R}(\vzD,\vzD)$. %We denote the Cholesky operation as $\mat{R}(\vzD,\vzD)=\chol(\mat{V}(\vzD,\vzD))$. 

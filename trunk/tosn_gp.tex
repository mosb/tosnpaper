...
\begin{center}
\begin{tabular}{cc}
\hspace{-0.75cm}\epsfig{figure=figures/cens.eps,width=7.2cm} & \hspace{-1.00cm}\epsfig{figure=figures/noncens.eps,width=7.2cm} \\
\hspace{-0.6cm}(a) & \hspace{-0.6cm}(b)
\end{tabular}
\caption{Prediction and regression of air pressure data for Gaussian processes assuming observations are (a) rounded to the nearest integer and (b) corrupted by simple Gaussian noise. The RMSEs are a) $0.6942 \,\text{Pa}$ and b) $0.9407\,\text{Pa}$.}

...
% Page heads
\markboth{M. A. Osborne et al.}{Real-Time Information Processing of Environmental Sensor Network Data using Bayesian Gaussian Processes}
...
\acmformat{Osborne, M. A., Roberts, S. J., Rogers, A. and Jennings, N. R. 2012. Real-time information processing of environmental sensor network data using Bayesian Gaussian processes.}
...
Author's addresses: M. A. Osborne {and} S. J. Roberts, Department of Engineering, Oxford University, Oxford, UK; A. Rogers {and} N. R. Jennings, Electronics and Computer Science, University of Southampton, Southampton, UK.
\end{bottomstuff}

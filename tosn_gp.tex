...
\cmmnt & ${\sc Mean}(x,\phi)$: & Mean function ($\mu$), taking as arguments an input $x$ and hyperparameter vector $\phi$. \\
\cmmnt & ${\sc Cov}(x,x';\phi)$: & Covariance function ($K$), taking as arguments two inputs $x$ and $x'$ and hyperparameter vector $\phi$. \\

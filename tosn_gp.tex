...
\markboth{M. A. Osborne et al.}{Computationally Efficient Multi-Output Gaussian Processes}
...
\p{\vyst}{\vyD,I} \simeq \vect{q}_S^\tr\, \frac{\mat{K}(\vph_{S},\vph_{S})^{-1}\,\Nt\,\mat{K}(\vph_{S},\vph_{S})^{-1}\,\vect{r}_S}
...
\begin{align} \label{eq:Marginalising}
& \p{\vxst}{\vyD,\vect{b}_c,I}=\nonumber\\
& \frac{\int\ud\phi\int_{\vect{b}_c}\ud\vy_c\, \p{\vxst}{\vyD,\vy_c,\phi,I}\p{\vy_c}{\vyD,\phi,I}\p{\vyD}{\phi,I}\p{\phi}{I}}
{\int\ud\phi\int_{\vect{b}_c}\ud\vy_c\, \p{\vy_c}{\vyD,\phi,I}\p{\vyD}{\phi,I}\p{\phi}{I}}\,.
\end{align}
While we cannot determine this full distribution easily, we can analytically determine its mean and covariance. We abuse notation slightly to have $\Ph{\vect{b}_c}{\vect{m}_c}{\mat{C}_c}\defequal\int$.
...
% Ambient temperature
% 30-Mar-2008
Figure \ref{active_sampling2} shows the results of an active sampling experiment over the Wannengrat data. It can be seen that there is a dramatic increase in sampling frequency coincident with the fluctuations in temperature that begin at about $t=0.7$ days.
...
\subsection{Datahalf Update}
\subsection{Datahalf Downdate}

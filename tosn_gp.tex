...
% Page heads
\markboth{M. A. Osborne et al.}{Real-Time Information Processing using Bayesian Gaussian Processes}

% Title portion
\title{Real-Time Information Processing of Environmental Sensor Network Data using Bayesian Gaussian Processes}
...
\acmformat{Osborne, M. A., Roberts, S. J., Rogers, A. and Jennings, N. R. 2012. Real-time information processing using Bayesian Gaussian processes.}

\begin{bottomstuff}
A preliminary version of the work presented in this paper appeared as: Osborne, M. A., Rogers, A., Ramchurn, S., Roberts, S. J. and Jennings, N. R. (2008) Towards Real-Time Information Processing of Sensor Network Data using Computationally Efficient Multi-output Gaussian Processes. In: International Conference on Information Processing in Sensor Networks (IPSN 2008), St. Louis, Missouri, USA. pp. 109-120.
 
Author's addresses: M. A. Osborne {and} S. J. Roberts, Department of Engineering Science, University of Oxford, Oxford, UK; A. Rogers {and} N. R. Jennings, Electronics and Computer Science, University of Southampton, Southampton, UK.
\end{bottomstuff}
...
\begin{equation*} %\label{eq:CensoredFull}
\p{\vyst}{\vzD,\vect{b}_c,I} = \frac{\int\ud\phi\int_{\vect{b}_c}\ud\vz_c\, \p{\vyst}{\vzD,\vz_c,\phi,I}\p{\vz_c}{\vzD,\phi,I}\p{\vzD}{\phi,I}\p{\phi}{I}}
...
\section{Evaluation Datasets}\label{sec_datasets}
...
\begin{center}
\begin{tabular}{cc}
\hspace{-1cm}\epsfig{figure=figures/AT_Bramble_GP.eps,width=7.2cm} & \hspace{-1.00cm}\epsfig{figure=figures/AT_Bramble_KF.eps,width=7.8cm} \\
\hspace{-1cm}\epsfig{figure=figures/AT_Chi_GP.eps,width=7.2cm} & \hspace{-1.00cm}\epsfig{figure=figures/AT_Chi_KF.eps,width=7.8cm} \\
\hspace{-0.6cm}(a) & \hspace{-0.6cm}(b) \\
\end{tabular}
...
\centering
% use packages: array
\textsl{}\caption{The numbers of stored data points, $N$, and hyperparameter samples, $\eta$, used for the various datasets presented in this paper.} 
...
\section{Trial Deployment}\label{sec_trial_deployment}

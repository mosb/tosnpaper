...
% Ambient temperature
% 30-Mar-2008
Figure \ref{active_sampling2} shows the results of an active sampling experiment over the Wannengrat data. It can be seen that there is a dramatic increase in sampling frequency coincident with the volatile fluctuations in temperature that begin at about $t=0.7$ days.

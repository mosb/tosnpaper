...
The predictive performances for this dataset are shown in table \ref{tbl:AT_RMSEs}. The Kalman filter was tested with an order of $p=15$. Note again that the multi-output GP outperforms the other benchmarks with the Kalman filter performing particularly badly, it significantly lagging the real temperature measurement.
